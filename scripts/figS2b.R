...
# load
df <- read.csv("../cohort/ctDNA_of_HER2_amplification_StageIII_for_R.csv")
# df <- read.csv("/path/to/your/ctDNA_of_HER2_amplification_StageIII_for_R.csv")
setDT(df)
